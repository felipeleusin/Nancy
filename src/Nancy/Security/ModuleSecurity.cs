namespace Nancy.Security
{
    ...
    public static class ModuleSecurity
    {
        ...
        public static void RequiresClaims(this INancyModule module, IEnumerable<Claim> requiredClaims)
        {
            module.AddBeforeHookOrExecute(SecurityHooks.RequiresAuthentication(), "Requires Authentication");
        ...
        /// <param name="module">Module to enable</param>
        /// <param name="requiredClaims">Claim(s) required</param>
        public static void RequiresAnyClaim(this INancyModule module, IEnumerable<Claim> requiredClaims)
        {
            module.AddBeforeHookOrExecute(SecurityHooks.RequiresAuthentication(), "Requires Authentication");
